      ...
      sections: [
        {
          ...
          sortOrder: 1,
          fields: [
            { name: 'Fund Name', type: 'text', description: '', instruction: 'Official name of the fund' },
            { name: 'Fund Size', type: 'currency', description: '', instruction: 'Target or current fund size in USD' },
            { name: 'Vintage Year', type: 'number', description: '', instruction: 'Year the fund was launched' },
            { name: 'Strategy', type: 'select', description: '', instruction: 'Primary investment strategy', options: ['Buyout', 'Growth Equity', 'Venture Capital', 'Credit', 'Real Assets', 'Secondaries'] },
          ],
        },
        {
          ...
          sortOrder: 2,
          fields: [
            { name: 'Management Fee', type: 'percentage', description: '', instruction: 'Annual management fee percentage' },
            { name: 'Carried Interest', type: 'percentage', description: '', instruction: 'Carried interest percentage' },
            { name: 'Fund Term', type: 'text', description: '', instruction: 'Expected fund life (e.g., 10 years + 2 extensions)' },
            { name: 'Minimum Commitment', type: 'currency', description: '', instruction: 'Minimum LP commitment amount' },
          ],
        },
        {
          name: 'Performance',
          sortOrder: 3,
          fields: [
            { name: 'Target Net IRR', type: 'text', description: '', instruction: 'Target net IRR range' },
            { name: 'Target Net MOIC', type: 'text', description: '', instruction: 'Target net multiple on invested capital' },
            { name: 'Prior Fund Performance', type: 'textarea', description: '', instruction: 'Summary of predecessor fund track record' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          sortOrder: 1,
          fields: [
            { name: 'Company Name', type: 'text', description: '', instruction: 'Legal name of the target company' },
            { name: 'Sector', type: 'text', description: '', instruction: 'Primary industry sector' },
            { name: 'Revenue', type: 'currency', description: '', instruction: 'Latest annual revenue' },
            { name: 'EBITDA', type: 'currency', description: '', instruction: 'Latest annual EBITDA' },
          ],
        },
        {
          name: 'Deal Terms',
          sortOrder: 2,
          fields: [
            { name: 'Valuation', type: 'currency', description: '', instruction: 'Enterprise or equity valuation' },
            { name: 'Stake Offered', type: 'percentage', description: '', instruction: 'Percentage stake being offered' },
            { name: 'Investment Amount', type: 'currency', description: '', instruction: 'Proposed investment size' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          sortOrder: 1,
          fields: [
            { name: 'Lead Sponsor', type: 'text', description: '', instruction: 'Name of the lead GP/sponsor' },
            { name: 'Target Company', type: 'text', description: '', instruction: 'Name of the underlying target company' },
            { name: 'Co-Invest Allocation', type: 'currency', description: '', instruction: 'Amount available for co-investment' },
            { name: 'Fees', type: 'text', description: '', instruction: 'Fee structure (e.g., no management fee, reduced carry)' },
          ],
        },
        {
          ...
          sortOrder: 2,
          fields: [
            { name: 'Sponsor AUM', type: 'currency', description: '', instruction: 'Lead sponsor assets under management' },
            { name: 'Prior Co-Invests', type: 'number', description: '', instruction: 'Number of prior co-investment opportunities offered' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          sortOrder: 1,
          fields: [
            { name: 'Description', type: 'textarea', description: '', instruction: 'Describe the investment opportunity' },
            { name: 'Asset Class', type: 'text', description: '', instruction: 'Asset class or category' },
            { name: 'Expected Return', type: 'text', description: '', instruction: 'Target return profile' },
          ],
        },
      ],
    },
...
export const MOCK_EVENTS: DealEvent[] = [
  {
    id: 'event-1',
    title: 'Abingworth VIII — LP Meeting',
    type: 'meeting',
    description: 'Initial LP meeting with Abingworth team to discuss Fund VIII strategy and terms.',
    opportunityId: 'opp-abingworth-viii',
    mandateId: null,
    startTime: '2026-04-18T10:00:00Z',
    endTime: '2026-04-18T11:30:00Z',
    location: 'Conference Room A',
    attendees: ['user-raoof', 'user-usman'],
    calendarEventId: 'gcal-abc123',
    createdBy: 'user-raoof',
    createdAt: '2026-04-10T08:00:00Z',
  ...
  {
    id: 'event-2',
    title: 'BREP X — Site Visit',
    type: 'site_visit',
    description: 'Tour of Blackstone Real Estate Partners X portfolio property in Downtown Dubai.',
    opportunityId: 'opp-brep-x',
    mandateId: null,
    startTime: '2026-04-20T09:00:00Z',
    endTime: '2026-04-20T12:00:00Z',
    location: 'Downtown Dubai, Tower 3',
    attendees: ['user-pine', 'user-raoof'],
  ...
  },
  {
    ...
    type: 'call',
    description: 'Regular weekly call to review active pipeline and prioritize opportunities.',
    opportunityId: null,
    mandateId: null,
    startTime: '2026-04-17T14:00:00Z',
    endTime: '2026-04-17T15:00:00Z',
    location: null,
    attendees: ['user-raoof', 'user-usman', 'user-pine', 'user-john'],
    calendarEventId: 'gcal-weekly-001',
    createdBy: 'user-usman',
    createdAt: '2026-04-01T10:00:00Z',
    updatedAt: '2026-04-01T10:00:00Z',
  },
  {
    id: 'event-4',
    title: 'IC Review — Sequoia Growth Fund V',
    type: 'meeting',
    description: 'Investment committee review for Sequoia Growth Fund V.',
    opportunityId: 'opp-sequoia-gf-v',
    mandateId: 'mandate-growth',
    startTime: '2026-04-22T10:00:00Z',
    endTime: '2026-04-22T12:00:00Z',
    location: 'Board Room',
    attendees: ['user-raoof', 'user-usman', 'user-pine', 'user-sarah'],
    calendarEventId: null,
    createdBy: 'user-raoof',
  ...
  {
    id: 'event-5',
    title: 'Q2 Allocation Deadline',
    type: 'deadline',
    description: 'Final deadline for Q2 allocation decisions across all active mandates.',
    opportunityId: null,
    mandateId: null,
    startTime: '2026-04-30T23:59:00Z',
    endTime: null,
    location: null,
    attendees: [],
    calendarEventId: null,
...
export const MOCK_TASKS: DealTask[] = [
  {
    id: 'task-1',
    title: 'Complete Abingworth VIII due diligence checklist',
    description: 'Review all outstanding DD items and prepare summary memo for IC.',
    priority: 'high',
    status: 'in_progress',
  ...
  {
    id: 'task-2',
    title: 'Update BREP X snapshot with Q1 data',
    description: null,
    priority: 'medium',
    status: 'todo',
    assigneeId: 'user-pine',
    assigneeName: 'Pine Anderson',
    opportunityId: 'opp-brep-x',
    mandateId: null,
    dueDate: '2026-04-21T23:59:00Z',
    completedAt: null,
    createdBy: 'user-raoof',
  ...
  {
    id: 'task-3',
    title: 'Review Brookfield credit fund LP materials',
    description: 'Newly received LP materials from James Wu need initial assessment.',
    priority: 'medium',
    status: 'todo',
  ...
  {
    id: 'task-4',
    title: 'Prepare Q1 pipeline summary for leadership',
    description: 'Quarterly deck summarizing pipeline flow, conversion rates, and mandate coverage.',
    priority: 'urgent',
    status: 'todo',
    assigneeId: 'user-raoof',
    assigneeName: 'Raoof Naushad',
  ...
  {
    id: 'task-5',
    title: 'Send Sequoia Growth Fund V questionnaire',
    description: null,
    priority: 'low',
    status: 'done',
    assigneeId: 'user-raoof',
...
export const MOCK_NOTIFICATIONS: DealNotification[] = [
  {
    id: 'notif-1',
    type: 'review_requested',
    title: 'Review Requested',
    message: 'Usman Khan requested your review on Abingworth VIII pre-screening documents.',
    read: false,
    linkTo: '/deals/opportunities/opp-abingworth-viii',
    entityId: 'opp-abingworth-viii',
  ...
  },
  {
    ...
    type: 'stage_changed',
    title: 'Stage Updated',
    message: 'BREP X moved to IC Review stage.',
    read: false,
    linkTo: '/deals/opportunities/opp-brep-x',
    entityId: 'opp-brep-x',
    entityType: 'opportunity',
  ...
  },
  {
    ...
    message: 'Email from James Wu about Brookfield Real Estate Credit Fund IV was imported.',
    read: true,
    linkTo: '/deals/email',
    entityId: 'email-8',
    entityType: 'email',
  ...
  },
  {
    ...
    message: 'Prepare Q1 pipeline summary for leadership is due tomorrow.',
    read: false,
    linkTo: '/deals/events',
    entityId: 'task-4',
    entityType: 'task',
  ...
  },
  {
    ...
    message: 'Sequoia Growth Fund V was created from email import.',
    read: true,
    linkTo: '/deals/opportunities/opp-sequoia-gf-v',
    entityId: 'opp-sequoia-gf-v',
    entityType: 'opportunity',
  ...
  },
  {
    ...
    message: 'Pine Anderson shared the BREP X Investment Memo with you.',
    read: true,
    linkTo: '/deals/opportunities/opp-brep-x',
    entityId: 'doc-2',
    entityType: 'document',
  ...
  },
  {
    ...
    type: 'mandate_match',
    title: 'Mandate Match',
    message: 'New opportunity Abingworth VIII has a strong fit with Growth Equity Mandate.',
    read: false,
    linkTo: '/deals/mandates/mandate-growth',
    entityId: 'mandate-growth',
    entityType: 'mandate',
  ...
  },
  {
    ...
    message: 'Pine Anderson approved the pre-screening for BREP X.',
    read: true,
    linkTo: '/deals/opportunities/opp-brep-x',
    entityId: 'approval-2',
    entityType: 'approval',
  ...
  },
  {
    ...
    type: 'comment_added',
    title: 'New Comment',
    message: 'Usman Khan commented on the Abingworth VIII Investment Memo.',
    read: false,
    linkTo: '/deals/opportunities/opp-abingworth-viii',
    entityId: 'comment-1',
    entityType: 'comment',
  ...
  },
  {
    ...
    type: 'task_assigned',
    title: 'Task Assigned',
    message: 'Sarah Johnson assigned you: Prepare Q1 pipeline summary for leadership.',
    read: false,
    linkTo: '/deals/events',
    entityId: 'task-4',
    entityType: 'task',
...
export const MOCK_CALENDAR_ACCOUNTS: GoogleCalendarAccount[] = [
  {
    id: 'gcal-acc-1',
    userId: 'user-raoof',
    emailAddress: 'raoof@watar.com',
    status: 'connected',
    lastSyncedAt: '2026-04-15T06:00:00Z',
    calendarId: 'primary',
    createdAt: '2026-04-01T10:00:00Z',
...
export const MOCK_COMMENTS: DocumentComment[] = [
  {
    id: 'comment-1',
    opportunityId: 'opp-abingworth-viii',
    documentId: 'doc-1',
    sectionHeading: 'Fund Overview',
    content: 'The fund size seems aggressive for the current market. Can we get more color on their deployment timeline?',
    authorId: 'user-usman',
  ...
  },
  {
    ...
    documentId: 'doc-1',
    sectionHeading: 'Fund Overview',
    content: 'Good point — they mentioned a 3-year deployment window in the LP meeting. I\'ll add that to the snapshot.',
    authorId: 'user-raoof',
  ...
  },
  {
    ...
    content: 'Prior fund IRR looks solid but we should benchmark against peers before IC review.',
    authorId: 'user-pine',
    authorName: 'Pine Anderson',
    parentId: null,
    createdAt: '2026-04-13T16:00:00Z',
