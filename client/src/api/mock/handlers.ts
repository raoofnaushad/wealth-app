...
export const handlers = [
  // ── Agents/Runs/Copilot: NO MSW mocks ──────────────────────────
  // These endpoints are served by the real Copilot backend (localhost:8000).
  // Requests pass through MSW (onUnhandledRequest: 'bypass') to the Vite proxy.
